    ...
    return (
        <div className="bg-black text-white py-20" id="contact">
            ...
            from-green-400 to-blue-500 mb-4'>Let's Talk</h3>
                        ...
                        <div className='mb-4'>
                            <AiOutlineWhatsApp className='inline-block text-green-400 mr-2'></AiOutlineWhatsApp>
                            <a href="https://wa.me/+34682044125" className="hover:underline">+34 682044125</a>
                        </div>
                        <div className='mb-4'>
                            <FaMapMarkedAlt className='inline-block text-green-400 mr-2'></FaMapMarkedAlt>
                            <span>Calle San Rafael, Leon, Spain
                            </span>
                        </div>
                    </div>
